...
if (NOT DEFINED AG_BUILD_CONFIGURED)
    ...
    macro(ag_configure_build)
        ...
        # TODO: Auto detect the following with a C program using try_run().
        option(AG_ENABLE_X64_V1 "Uses the capabilities of the x86-64 v1 architecture - SSE2" ON)
        option(AG_ENABLE_X64_V2 "Uses the capabilities of the x86-64 v2 architecture - SSE4, POPCNT, CMPXCHG16B" ON)
        option(AG_ENABLE_X64_V3 "Uses the capabilities of the x86-64 v3 architecture - AVX, AVX2, FMA, LZCNT" ON)
        option(AG_ENABLE_X64_V4 "Uses the capabilities of the x86-64 v4 architecture - AVX512F/BW/CD/DQ/VL" OFF)
    ...
    macro(ag_configure_bzip2)
        ...
        if (bzip2_POPULATED)
            ...
            message(FATAL_ERROR "Failed to obtain bzip2 source code.")
        endif()
    ...
    macro(ag_configure_glm)
        ...
        elif(CMAKE_SYSTEM_PROCESSOR STREQUAL "aarch64")
            set(GLM_ENABLE_SIMD_AVX2 OFF CACHE "BOOL" "Use AVX2 in GLM" FORCE)
            set(GLM_ENABLE_SIMD_AVX OFF CACHE "BOOL" "Use AVX in GLM" FORCE)
            set(GLM_ENABLE_SIMD_SSE4_2 OFF CACHE "BOOL" "Use SSE4.2 in GLM" FORCE)
            set(GLM_ENABLE_SIMD_SSE4_1 OFF CACHE "BOOL" "Use SSE4.1 in GLM" FORCE)
    ...
    macro(ag_configure_sdl3)
        ...
        if (AG_ENABLE_X64_V4)
            set(SDL_AVX512F ON CACHE "BOOL" "Use AVX512 in SDL3" FORCE)
            set(SDL_AVX2 ON CACHE "BOOL" "Use AVX2 in SDL3" FORCE)
            set(SDL_AVX ON CACHE "BOOL" "Use AVX in SDL3" FORCE)
            set(SDL_SSE4_2 ON CACHE "BOOL" "Use SSE4.2 in SDL3" FORCE)
            set(SDL_SSE4_1 ON CACHE "BOOL" "Use SSE4.1 in SDL3" FORCE)
            set(SDL_SSE3 ON CACHE "BOOL" "Use SSE3 in SDL3" FORCE)
            set(SDL_SSE2 ON CACHE "BOOL" "Use SSE2 in SDL3" FORCE)
            set(SDL_SSE ON CACHE "BOOL" "Use SSE in SDL3" FORCE)
        elseif (AG_ENABLE_X64_V3)
            set(SDL_AVX512F OFF CACHE "BOOL" "Use AVX512 in SDL3" FORCE)
            set(SDL_AVX2 ON CACHE "BOOL" "Use AVX2 in SDL3" FORCE)
            set(SDL_AVX ON CACHE "BOOL" "Use AVX in SDL3" FORCE)
            set(SDL_SSE4_2 ON CACHE "BOOL" "Use SSE4.2 in SDL3" FORCE)
            set(SDL_SSE4_1 ON CACHE "BOOL" "Use SSE4.1 in SDL3" FORCE)
        ...
        elseif(AG_ENABLE_X64_V2)
            set(SDL_AVX512F OFF CACHE "BOOL" "Use AVX512 in SDL3" FORCE)
            set(SDL_AVX2 OFF CACHE "BOOL" "Use AVX2 in SDL3" FORCE)
            set(SDL_AVX OFF CACHE "BOOL" "Use AVX in SDL3" FORCE)
            set(SDL_SSE4_2 ON CACHE "BOOL" "Use SSE4.2 in SDL3" FORCE)
            set(SDL_SSE4_1 ON CACHE "BOOL" "Use SSE4.1 in SDL3" FORCE)
            set(SDL_SSE3 ON CACHE "BOOL" "Use SSE3 in SDL3" FORCE)
            set(SDL_SSE2 ON CACHE "BOOL" "Use SSE2 in SDL3" FORCE)
        ...
        elseif(AG_ENABLE_X64_V1)
            ...
            set(SDL_AVX2 OFF CACHE "BOOL" "Use AVX2 in SDL3" FORCE)
            set(SDL_AVX OFF CACHE "BOOL" "Use AVX in SDL3" FORCE)
            set(SDL_SSE4_2 OFF CACHE "BOOL" "Use SSE4.2 in SDL3" FORCE)
            set(SDL_SSE4_1 OFF CACHE "BOOL" "Use SSE4.1 in SDL3" FORCE)
            set(SDL_SSE3 OFF CACHE "BOOL" "Use SSE3 in SDL3" FORCE)
            set(SDL_SSE2 ON CACHE "BOOL" "Use SSE2 in SDL3" FORCE)
            set(SDL_SSE ON CACHE "BOOL" "Use SSE in SDL3" FORCE)
        elseif(AG_ENABLE_SIMD_SSE2)
            set(SDL_AVX512F OFF CACHE "BOOL" "Use AVX512 in SDL3" FORCE)
            set(SDL_AVX2 OFF CACHE "BOOL" "Use AVX2 in SDL3" FORCE)
            set(SDL_AVX OFF CACHE "BOOL" "Use AVX in SDL3" FORCE)
            set(SDL_SSE4_2 OFF CACHE "BOOL" "Use SSE4.2 in SDL3" FORCE)
            set(SDL_SSE4_1 OFF CACHE "BOOL" "Use SSE4.1 in SDL3" FORCE)
            set(SDL_SSE3 OFF CACHE "BOOL" "Use SSE3 in SDL3" FORCE)
            set(SDL_SSE2 OFF CACHE "BOOL" "Use SSE2 in SDL3" FORCE)
            set(SDL_SSE OFF CACHE "BOOL" "Use SSE in SDL3" FORCE)
        endif()

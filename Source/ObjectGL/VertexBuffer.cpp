...
BufferName VertexBuffer::getName() const
{
                        ...
                        BufferUsage usage)
{
    ...
    api.bufferData(BufferTarget::ArrayBuffer,
...
//! valid resource.
const GLAPI &VertexBuffer::verifyAccess(const char *operation) const
{
    if (_buffer)
    {
    ...
    {
        throw Ag::ObjectNotBoundException("VertexBuffer", operation);
    }
}

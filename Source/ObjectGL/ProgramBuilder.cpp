...
ShaderCompilationException::ShaderCompilationException(ShaderType type,
                                                       const std::string_view &errors)
{
    ...
    switch (type)
    {
    case ShaderType::FragmentShader: message.append("fragment "); break;
    case ShaderType::VertexShader: message.append("vertex "); break;
    case ShaderType::GeometryShader: message.append("geometry "); break;
    case ShaderType::TessEvaluationShader: message.append("tessellator evaluation "); break;
    case ShaderType::TessControlShader: message.append("tessellator control "); break;
    case ShaderType::ComputeShader: message.append("compute "); break;
    }
...
size_t ProgramBuilder::addShader(ShaderType type,
...
bool ProgramBuilder::tryCreate(Program &program, Ag::string_ref_t &errors)
{
    bool isOK = false;

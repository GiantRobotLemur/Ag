//! @file Ag/Win32Base/Win32API.hpp
//! @brief Gathers macro defines and includes required to reference the Win32 API
//! which are required internally by the Win32Base module.
...
#ifndef __AG_WIN32_BASE_WIN32_API_HPP__
#define __AG_WIN32_BASE_WIN32_API_HPP__

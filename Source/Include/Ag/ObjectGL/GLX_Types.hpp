...
namespace Global {
    ...
    static const GLenum Texture2DBit                               = 0x00000002; // GLX_TEXTURE_2D_BIT_EXT
    ...
    static const GLenum TextureRectangleBit                        = 0x00000004; // GLX_TEXTURE_RECTANGLE_BIT_EXT
    ...
    static const GLenum SampleBuffersBit                           = 0x00000100; // GLX_SAMPLE_BUFFERS_BIT_SGIX
    ...
    static const GLenum Texture1D                                  =     0x20DB; // GLX_TEXTURE_1D_EXT
    static const GLenum Texture2D                                  =     0x20DC; // GLX_TEXTURE_2D_EXT
    static const GLenum TextureRectangle                           =     0x20DD; // GLX_TEXTURE_RECTANGLE_EXT
